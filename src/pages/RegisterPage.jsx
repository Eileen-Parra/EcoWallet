...
function RegisterPage({ heroe, onGuardar, onNavegar }) {
  ...
  function handleGuardar() {
    ...
    const xp = Math.floor(precioNum / 5000) + 10
    setXpGanada(xp)
    setGuardado(true)
        ...
        <div style={styles.card}>
            ...
            <div style={styles.catGrid}>
              {CATEGORIAS.map(cat => (
                <button
                  ...
                  style={{
                    ...styles.catBtn,
                    background:   categoria === cat.id ? 'var(--bg4)' : 'var(--bg3)',
                    border:       categoria === cat.id
                      ? `1px solid ${cat.color}`
                      : '1px solid var(--border)',
                    transform: categoria === cat.id ? 'scale(1.05)' : 'scale(1)',
                  }}
          ...
          {precioNum > 0 && (
            <div style={{
              ...
              <div style={styles.previewFila}>
                ...
                <span style={{ color: catActual.color, fontFamily: 'Cinzel, serif',
                  fontSize: '13px' }}>
              ...
              <div style={styles.previewFila}>
                ...
                <span style={{ ...styles.previewValor, color: 'var(--cat-tech)' }}>
                  {co2Est} kg
                </span>
              </div>
            </div>
          ...
          <button
            style={{
              ...
              background:     guardado ? 'var(--cat-tech)' : 'var(--silver-200)',
            }}
            onClick={handleGuardar}
            disabled={!formularioValido}
          >
            {guardado ? `✓ ¡Registrado! +${xpGanada} XP` : '⚔️ Registrar en los pergaminos'}
          </button>
        </div>
